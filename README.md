...
- Tools extended on toolbar at top, upload video, strikethrough, and other data / information entry tools
- Removed text notification on ***Day/Date*** for ***Reminders*** and ***Task Orders***. Grouped by total number now.
- Shortened the preview for the ***entry*** on a ***Day/Date***
- Need to fix the preview of images on ***Day/Date***
- Need to fix the issue with 
